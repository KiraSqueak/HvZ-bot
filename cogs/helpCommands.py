...
class helpCommands(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        if modRole in ctx.author.roles:
            ...
            myEmbed.add_field(name="Register", value="Registers all users. Format: $register", inline=False)
            myEmbed.add_field(name="Clear Data", value="Clears all data from game. Format: $clearData", inline=False)
